...
export const clinicUnit: UnitDefinition = {
  ...
  fields: [
    { key: 'address', label: '地址', type: 'text', required: true, group: '基本資料' },
    { key: 'phone', label: '電話', type: 'text', required: true, group: '基本資料' },
    { key: 'lineUrl', label: 'LINE 連結', type: 'text', group: '基本資料' },
    { key: 'latitude', label: '緯度', type: 'number', group: '地圖', hint: 'LocalBusiness schema 的 geo 需要（docs/08 §C-7）。' },
    { key: 'longitude', label: '經度', type: 'number', group: '地圖' },
    ...
    { key: 'intro', label: '簡介', type: 'richtext', group: '基本資料' },
    {
      ...
      type: 'hours',
      group: '營業時間',
      hint: '星期 × 時段矩陣，一天可有多列以表達午休斷點；某天完全沒有列＝休診（docs/08 §C-7）。',
    },
