...
| 301 規則 | **約 770** | 主站。**下限**，孤兒頁面尚未盤點。跨網域的 blog 站不在範圍內 |
...
>
> ⚠️ 連帶要重算的是「URL 實例約 950」—— 文章從估的 800 變成實數 1100，
> 標籤頁也從 10 個變成約 390 個（blog 的 46 個分類壓成 4 個之後全轉成標籤）。
> **匯入完成前先不要改那個數字**，等建置產物出來再以實數更新。
