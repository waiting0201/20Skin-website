...
> 這裡記錄**規格與施工標準**。「做到哪裡了」在 [`../STATUS.md`](../STATUS.md)，
> 專案規範與已定案決策在 [`../CLAUDE.md`](../CLAUDE.md)。
...
|---|---|
| 前台模板 | 21 |
| URL 實例 | **1845**（實數，2026-09-14 建置產物計數） |
| 後台畫面 | 約 30 |
| 療程項目 | 28（2026-09-14 由 27 更正，見 [06](06-page-inventory.md) §3） |
