...
export const SEED_DOCTORS: SeedRecord[] = [
  {
    ...
    fields: {
      ...
      isPhysician: true,
      specialty: '皮膚科',
      photo: { blobPath: '', url: '/assets/img/doctor-chao.jpg', alt: null, width: null, height: null, variants: null },
      credentials: [
  ...
  },
  {
    ...
    fields: {
      ...
      isPhysician: true,
      specialty: '皮膚科',
      photo: { blobPath: '', url: '/assets/img/doctor-huang.jpg', alt: null, width: null, height: null, variants: null },
  ...
  },
  {
    ...
    fields: {
      ...
      isPhysician: false,
      specialty: '新中式美學創始人',
      photo: { blobPath: '', url: '/assets/img/doctor-anqiao.jpg', alt: null, width: null, height: null, variants: null },
...
export const SEED_TREATMENTS: SeedRecord[] = [
  {
    ...
    fields: {
      ...
      deviceInfo: '示意儀器資訊。',
      cover: { blobPath: '', url: '/assets/img/product-p01.png', alt: null, width: null, height: null, variants: null },
    },
  },
  {
...
export const SEED_CONCERNS: SeedRecord[] = [
  {
    ...
    fields: {
      ...
      cover: { blobPath: '', url: '/assets/img/stock-facial-calm.jpg', alt: null, width: null, height: null, variants: null },
    },
  },
  {
...
export const SEED_ARTICLES: SeedRecord[] = [
  {
    ...
    fields: {
      ...
      cover: { blobPath: '', url: '/assets/img/index-p01.jpg', alt: null, width: null, height: null, variants: null },
      summary: '示意摘要文字。',
